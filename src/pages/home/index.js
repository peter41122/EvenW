  ...
  return (
    <>
      <div className="w-full absolute right-0 left-0 top-0">
        <div className="pb-4 sm:pb-0 bg-[#012060] h-[25rem] flex flex-col justify-end px-4 md:px-20 z-[1] relative">
          <div className="text-3xl sm:text-4xl mb-1 text-white">Cross border payment</div>
          ...
          <div className="mb-5 text-[16px] text-white">
            We make it easier for merchants to open and run a business account for
